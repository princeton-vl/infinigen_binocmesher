...
DEVICE_FUNC void geo_ice(float3_nonbuiltin position, float3_nonbuiltin normal,
    ...
    node_shader_tex_noise(4, position, W1__Value, Scale1__Value, 13.0, 1.0, 0.0,
    ...
    node_shader_vector_math(
        ...
        0.0, &Vector_SPACE_Math__Vector, NULL);
    float W2__Value;
    ...
    node_shader_tex_noise(4, position, W2__Value, Scale2__Value, 13.0,
    ...
    node_shader_vector_math(
        ...
        float3_nonbuiltin(0.0, 0.0, 0.0), float3_nonbuiltin(0.0, 0.0, 0.0),
        0.08, &Vector_SPACE_Math_DOT_002__Vector, NULL);
